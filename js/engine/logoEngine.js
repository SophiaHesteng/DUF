...
export class LogoEngine {
    ...
    showModul1() {
        ...
        /*---- Let session-markering (ikke svar/indhold) - bruges af Byggesten til at vise en anden velkomst, hvis brugeren allerede har arbejdet med Logo i samme besøg ----*/
        sessionStorage.setItem("duf-visited-logo", "1");
    ...
    showModul8() {
        ...
        showDocumentation(modul8, draftText.trim(), () => this.saveAndFinish(), () => this.exitRoom());
    }
    ...
    async saveAndFinish() {
        ...
        const data = {
            ...
            modul6Description: this.modul6Description
        };
